...
import { getExchangeRate, toPi } from './pi-utils.js';
...
// ============================================
// DISPLAY PRODUCTS - EXPORTÉ CORRECTEMENT
// ============================================
    ...
    if (!products || products.length === 0) {
        container.innerHTML = `
            <div class="col-span-2 text-center py-8 text-gray-500">
                ...
                <p class="text-sm">Aucun produit disponible</p>
...
// ============================================
// DISPLAY CATEGORIES - EXPORTÉ CORRECTEMENT
// ============================================
...
// ============================================
// SHOW ALERT - EXPORTÉ CORRECTEMENT
// ============================================
